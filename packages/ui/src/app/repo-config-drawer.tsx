...
type RepoConfigDrawerProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
  onReposChanged: () => void
}

export function RepoConfigDrawer({ open, onOpenChange, onReposChanged }: RepoConfigDrawerProps) {
    ...
    <Drawer direction="right" open={open} onOpenChange={onOpenChange}>
      <DrawerContent>
        <DrawerHeader>
          ...
          <DrawerDescription>Manage repository paths</DrawerDescription>
        </DrawerHeader>
